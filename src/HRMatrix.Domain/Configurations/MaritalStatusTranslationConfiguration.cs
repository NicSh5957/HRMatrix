...
public class MaritalStatusTranslationConfiguration : IEntityTypeConfiguration<MaritalStatusTranslation>
{
    public void Configure(EntityTypeBuilder<MaritalStatusTranslation> builder)
    {
        ...
        builder.HasData(
            ...
            new MaritalStatusTranslation { Id = 3, MaritalStatusId = 2, Name = "Single", LanguageCode = "en-US" },
            new MaritalStatusTranslation { Id = 4, MaritalStatusId = 2, Name = "Бекар", LanguageCode = "ky-KG" },

            new MaritalStatusTranslation { Id = 5, MaritalStatusId = 3, Name = "Divorced", LanguageCode = "en-US" },
            new MaritalStatusTranslation { Id = 6, MaritalStatusId = 3, Name = "Ажыратылган", LanguageCode = "ky-KG" }
        );
    }
}